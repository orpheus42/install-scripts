...
# install composer and move to /usr/local/bin
...
# install Bower, Yeoman, Grunt, and Gulp
sudo npm install -g bower
sudo npm install -g yo
sudo npm install -g grunt-cli
sudo npm install -g gulp

# move home directory files into place
sudo cp resources/home/.bashrc /home/vagrant
